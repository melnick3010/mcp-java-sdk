 ...
 *
 * Backported for Java 1.8: - Replaced Java record with a final class (Call). - Replaced
 * List.copyOf with an immutable snapshot via Collections.unmodifiableList(new
 * ArrayList<>(...)). - Made generics explicit for HandlerFilterFunction/HandlerFunction.
 *
...
public class McpTestRequestRecordingExchangeFilterFunction
	...
	/**
	 * Java 8 replacement for the original record: public record Call(HttpMethod method,
	...
	public static final class Call {
		...
		public boolean equals(Object o) {
			...
			if (!(o instanceof Call))
				return false;
			Call that = (Call) o;
			return method == that.method && Objects.equals(headers, that.headers) && Objects.equals(body, that.body);
		}
		...
		public String toString() {
			return "Call{" + "method=" + method + ", headers=" + headers + ", body='" + body + '\'' + '}';
		}
