...
public class HttpSseClientPingStandaloneMockTest {
    ...
    static void startMockServer() {
        ...
        ImageFromDockerfile image = new ImageFromDockerfile()
            .withFileFromString("package.json",
        ...
        serverContainer = new GenericContainer<>(image)
    ...
    void testPingSuccess_clientIsolated_againstMockDockerServer() throws Exception {
        ...
        try {
            ...
            // Il client, alla ricezione del REQUEST 'ping', costruisce automaticamente la RESPONSE
            // e la POSTa all’endpoint; se l’HTTP client non è bloccato, il server mock risponde 200.
