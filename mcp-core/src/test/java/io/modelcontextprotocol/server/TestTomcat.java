...
public class TestTomcat {
    ...
    private void run() {
        ...
        try {
            ...
            // ATTENDI che l'endpoint dei messaggi venga scoperto via SSE (evento 'endpoint')
    ...
    /**
     * Attende finché il transport ha scoperto l'endpoint dei messaggi (via evento SSE "endpoint").
     * Usa reflection per leggere il campo private AtomicReference<String> messageEndpoint.
     */
